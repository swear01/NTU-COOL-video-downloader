...
active jobs, including transfers waiting for a shared slot. Popup and batch downloads
share two offscreen slots; overflow waits automatically until browser saving
finishes or a transfer fails/cancels. Paused waiting jobs are skipped until resumed.
Each video uses 4–32 fragment requests (at most 64 across two).
